...
from data.tiny import TinyImageNetDataset
...
if args.dataset=='tiny':
    ...
    args.epoch_decay_start = 100
    # args.n_epoch = 200
    train_dataset = TinyImageNetDataset(root_dir="../data/test/tiny-imagenet-200/",
                                        mode="train",
                                        # download=True,
                                        transform=transforms.ToTensor(),
                                        noise_type=args.noise_type,
    ...
    print("tiny load 成功一半")
    test_dataset = TinyImageNetDataset(root_dir="../data/test/tiny-imagenet-200/",
                                        mode="test",
                                        # download=True,
                                        transform=transforms.ToTensor(),
                                        noise_type="clean",
...
def main():
    ...
    print('loading dataset to loader...')
