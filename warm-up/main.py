...
def train(train_loader,epoch, model1, optimizer1, model2, optimizer2, num_classes):
    ...
    for i, (images, labels, indexes) in enumerate(train_loader):
        ...
        warm_up = 10
        loss_1, loss_2, pure_ratio_1, pure_ratio_2, entropy_list = loss_coteaching(logits1, logits2, 
                                                                                    labels, rate_schedule[epoch], ind, 
                                                                                    noise_or_not, re_1,re_2, epoch, warm_up)
...
def main():
    ...
    # plt.legend()
    # # plt.title('')
    # plt.savefig('./pic/{}_{}.png'.format("cifar10_model_training",args.n_epoch))
    # plt.clf()
