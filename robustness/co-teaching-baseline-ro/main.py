...
from gen_adv import gen_adv_dataset
...
def train(train_loader,epoch, model1, optimizer1, model2, optimizer2, num_classes):
    ...
    for i, (images, labels, indexes) in enumerate(train_loader):
        ...
        loss_1, loss_2, pure_ratio_1, pure_ratio_2 = loss_coteaching(logits1, logits2, labels, rate_schedule[epoch], ind, noise_or_not, re_1,re_2)
...
def main():
    ...
    for epoch in range(1, args.n_epoch):
        ...
        train_acc1, train_acc2, pure_ratio_1_list, pure_ratio_2_list  =train(train_loader, epoch, cnn1, optimizer1, cnn2, optimizer2, num_classes)
        # entropy_1.append(entropy_list[0])
        # entropy_2.append(entropy_list[-1])
        # evaluate models
        test_acc1, test_acc2=evaluate(test_loader, cnn1, cnn2)
    ...
    # torch.save(cnn1, './model/baseline_pre_model_40_pair_0.4.pth')
    # cnn_load = torch.load('./model/baseline_pre_model_40_pair_0.4.pth')
    # cnn_load.cuda()
    # print("________________________________________________")
    # print(evaluate(test_loader, cnn_load, cnn_load))
    # print("________________________________________________")
    # sys.exit()

    cnn_load = torch.load('./model/baseline_pre_model_40_pair_0.4.pth')
    cnn_load.cuda()
    fgsm_robustness, pgd_robustness = gen_adv_dataset(test_loader, model=cnn_load,test_model= cnn1)
    print("fgsm robustness: ", fgsm_robustness)
    print("pgd robustness: ", pgd_robustness)
