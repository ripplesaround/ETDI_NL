...
def main():
    ...
    # torch.save(cnn1, './model/pre_model_no_train.pth')
    
    # cnn_load = torch.load('./model/pre_model_40.pth')
    # cnn_load.cuda()
    ...
    # torch.save(cnn1, './model/pre_model_40_pair_0.4.pth')
    # cnn_load = torch.load('./model/pre_model_40_pair_0.4.pth')
    # cnn_load.cuda()
